...
public interface CartModeServices {
     ...
     * @return ListString Lista de string con los nombres de los jugadores.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
   ...
   /**
     ...
     *
     * @return  resp Que representa una lista con los nombres de todos lo jugadores del juego.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
     ...
     *
     * @return player Retorna una lista de tipo jugador con los jugadores del 
     * juego.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
     ...
     * @return CartaJavSc Retorna una lista de tipo CartaJavSc con las cartas 
     * generadas segun el nivel indicado..
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
     ...
     * @return CartaJavSc Regresa una lista de tipo CartaJavSc con las cartas 
     * generadsa segun el nivel.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
     ...
     * @return Integer Retorna la cantidad de jugadores en el juego.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
     ...
     * @return List List String Retorna una lista de listas de tipo String.
     * @throws CartModeException Genera una excepcion cuando ocurre un error.
     */
